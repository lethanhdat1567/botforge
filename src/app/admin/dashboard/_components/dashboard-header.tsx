  ...
  return (
    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      <div className="space-y-1">
        <h1 className="text-2xl font-bold tracking-tight text-stone-900">Quản trị hệ thống</h1>
        <p className="text-xs text-stone-500 font-medium italic">Tổng quan hoạt động của toàn bộ nền tảng BotForge</p>
      </div>
