...
function MetricCard({ 
  ...
  return (
    <motion.div 
      ...
      className="group"
    >
      <Card className="border-border bg-card group relative overflow-hidden py-0 shadow-sm transition-all hover:border-border hover:shadow-md">
        ...
        <CardContent className="px-4 pb-4">
          <div className="flex items-baseline justify-between align-bottom">
            ...
            <div className={cn(
              "flex items-center rounded-full border border-border px-1.5 py-0.5 text-[10px] font-bold",
              isPositive
                ? "bg-emerald-500/10 text-emerald-800 dark:bg-emerald-500/15 dark:text-emerald-400"
                : "bg-red-500/10 text-red-800 dark:bg-red-500/15 dark:text-red-400",
            )}>
              {change}
